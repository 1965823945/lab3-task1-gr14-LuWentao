...
/* Assinging the values to StudentData*/ student.stu_name = "Lu Wentao"; student.stu_id = 2123384; student.stu_age = 21;
/* new structure */
student.stuAddress.street = "4, pr. Nezavisimosti"; student.stuAddress.state = "Minskaya"; student.stuAddress.city = "Minsk"; student.stuAddress.country = "Belarus";
